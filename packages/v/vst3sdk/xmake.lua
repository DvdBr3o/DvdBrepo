package("vst3sdk")
    ...
    on_install(function(package)
        ...
        os.cp("base", package:installdir("include/base"))
        os.cp("pluginterfaces", package:installdir("include/pluginterfaces"))
        os.cp("public.sdk", package:installdir("include/public.sdk"))
        os.cp("vstgui4", package:installdir("include/vstgui4"))
